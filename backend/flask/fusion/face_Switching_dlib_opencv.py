...
# coding: utf-8
#需要的接口文件
#Base_path = './pic/test1.jpg'
#cover_path = './pic/test2.jpg'

#返回的对齐之后的文件：cv2.imwrite('./pic/output.jpg', output_im) 
#是以第一张图为模板，第二张图与模板对齐之后的结果
# In[1]:
...
MOUTH_POINTS = list(range(48, 61))  # 嘴巴​/.../shape_predictor_68_face_landmarks.dat
...
cv2.imwrite('./pic/output.jpg', output_im)  # 换脸数据保存
...
cv2.imwrite('./pic/aligned2.jpg', warped_mask)  # 对齐的图数据保存
...
im1, landmarks1 = read_im_and_landmarks('./pic/test2.jpg')  # 底图
